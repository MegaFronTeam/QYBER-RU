      ...
      <div class="template">
        ...
        <DataTable :value="products">
          ...
          >
            ...
            <template #body="slotProps">
              <span class="text">{{ slotProps.data.playerCount }}</span>
            </template>
          </Column>
          <Column
            :header-props="{ 'sort-icon': 'mdi-triangle-down' }"
          ...
          >
            ...
            <template #body="slotProps">
              <div class="d-flex align-items-center">
                <span class="text">{{ slotProps.data.role }}</span>
                <Button severity="gray" label="Перейти" />
              </div>
            </template>
          </Column>
        </DataTable>
