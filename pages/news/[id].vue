<template>
  <HeaderBlock
    title="Начало турнира Кибер Атланты Осень 2024 по Dota 2"
  ...
  >
    ...
    <div class="sHeaderBlock__author">
      ...
      <div class="sHeaderBlock__author-date">30 января 2024, 17:50</div>
    </div>
  </HeaderBlock>
  <Content />
  <!-- <h1>News page with id {{ $route.params.id }}</h1> -->
</template>
